...
from tokenizer.tokenization_enc_dec import EncDecTokenizer
...
def make_gpt2_dataloaders(args):
    ...
    def make_data_loader_(data_path):
        ...
        #dataset = TensorDataset(data_path,if_dir=False)
    ...
    # Tokenizer.
    tokenizer = EncDecTokenizer(vocab_file="vocab.txt")
    eod_token = tokenizer.encoder[tokenizer.eod_token]
